...
import type { ManagedUser, ManagedUserStatus } from '../../types/userManagement'
import { statusLabels } from '../../types/userManagement'
  ...
  if (users.length === 0) {
    return (
      <div className="px-6 py-16 text-center">
        <p className="text-3xl font-bold text-slate-900">No hay estudiantes para mostrar</p>
        <p className="mt-3 text-sm text-slate-500">
          Ajusta la búsqueda o registra al primer estudiante en el sistema.
        </p>
      </div>
    )
  }
                ...
                <td className="px-4 py-4">
                  <div className="flex items-center justify-end gap-4 text-slate-400">
                    <button
                      ...
                      aria-label={`Editar estudiante ${user.names}`}
                    >
                    ...
                    <button
                      ...
                      aria-label={`Eliminar estudiante ${user.names}`}
                    >
