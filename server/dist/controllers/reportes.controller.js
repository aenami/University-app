...
exports.reporteResumen = exports.reportePqr = exports.reporteAsistencia = exports.reporteNotas = exports.reporteMatriculas = exports.reporteOferta = exports.reporteUsuarios = void 0;
...
exports.reporteUsuarios = reporteUsuarios;
// GET /api/reportes/oferta
const reporteOferta = async (req, res) => {
    const pool = (0, db_js_1.getConnection)();
    try {
...
exports.reporteOferta = reporteOferta;
// GET /api/reportes/matriculas
const reporteMatriculas = async (req, res) => {
    const pool = (0, db_js_1.getConnection)();
    try {
        const { id_programa } = req.query;
        let query = `
...
exports.reporteNotas = reporteNotas;
...
exports.reporteAsistencia = reporteAsistencia;
// GET /api/reportes/pqr
const reportePqr = async (req, res) => {
    const pool = (0, db_js_1.getConnection)();
    try {
        const { estado } = req.query;
        let query = `
...
exports.reportePqr = reportePqr;
// GET /api/reportes/resumen
const reporteResumen = async (req, res) => {
    const pool = (0, db_js_1.getConnection)();
    try {
        const [[{ total_usuarios }]] = await pool.query(`SELECT COUNT(*) AS total_usuarios FROM usuario`);
        const [[{ total_estudiantes }]] = await pool.query(`SELECT COUNT(*) AS total_estudiantes FROM estudiante`);
        const [[{ total_matriculas }]] = await pool.query(`SELECT COUNT(*) AS total_matriculas FROM matricula`);
        const [[{ total_grupos }]] = await pool.query(`SELECT COUNT(*) AS total_grupos FROM grupo`);
        const [[{ total_pqr_pendientes }]] = await pool.query(`SELECT COUNT(*) AS total_pqr_pendientes FROM pqr WHERE estado_pqr = 'pendiente'`);
        const [[{ total_programas }]] = await pool.query(`SELECT COUNT(*) AS total_programas FROM programa`);
        const [[{ total_asistencias }]] = await pool.query(`SELECT COUNT(*) AS total_asistencias FROM asistencia`);
        res.status(200).json({
            ok: true,
            origen: ORIGEN_REAL,
            data: {
...
exports.reporteResumen = reporteResumen;
