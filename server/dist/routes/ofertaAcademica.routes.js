...
router.post("/asignaturas/:idAsignatura/prerrequisitos", ofertaAcademica_controller_js_1.crearPrerrequisito);
router.get("/asignaturas/:idAsignatura/prerrequisitos", ofertaAcademica_controller_js_1.consultarPrerrequisitos);
router.post("/pensums", ofertaAcademica_controller_js_1.crearPensum);
router.get("/pensums", ofertaAcademica_controller_js_1.consultarPensums);
